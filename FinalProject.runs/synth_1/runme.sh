...
HD_PWD='C:/Users/ads5915/Desktop/FinalProject/FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PC_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PC_register.tcl
