...
HD_PWD='C:/Users/ads5915/Desktop/FinalProject/FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PC_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PC_register.tcl -notrace
